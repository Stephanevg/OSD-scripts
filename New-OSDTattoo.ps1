...
#Loading task sequence COM object
    ...
    $PSDistrict_TaskSequenceInstallationName = $tsenv.Value("_SMSTSPackageName")
    $PSDistrict_BootImageVersion = $tsenv.Value("_SMSTSBootImageID")
    $PSDistrict_DeploymentID = $tsenv.Value("_SMSTSLogPath")
    $PSDistrict_InstallationMethod = $tsenv.Value("_SMSTSMediaType")
    $PSDistrict_TaskSequenceInstallationID = $tsenv.Value("_SMSTSPackageID")
    $PSDistrict_SiteCode = $tsenv.Value("_SMSTSSiteCode")
    $PSDistrict_Buildversion = $tsenv.Value("OsBuildVersion")
